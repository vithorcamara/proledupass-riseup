...
const SearchIcon = () => <Search className="w-12 h-12 text-[#30ADE7] mb-4" />;
...
export default function Steps() {
  const stepsData = [
    {
      ...
      description:
        "Explore as oportunidades disponíveis e escolha a ideal para você ou seus dependentes.",
    },
    {
      number: 2,
      icon: <UserPlusIcon />,
      title: "Cadastre-se",
      description:
        "Crie sua conta e registre os dados do bolsista de forma rápida e fácil.",
    },
    {
      number: 3,
      icon: <CheckBadgeIcon />,
      ...
      description:
        "Finalize a inscrição, baixe seu contrato e compareça à instituição escolhida.",
    },
  ];
  ...
  return (
    <section
      id="comofunciona"
      className="bg-slate-100 py-16 md:py-20 px-4 sm:px-6 lg:px-8"
    >
      <div className="max-w-6xl mx-auto text-center">
        ...
        <p className="text-slate-600 mb-12 md:mb-16 max-w-3xl mx-auto text-base md:text-lg leading-relaxed">
          Conquistar sua bolsa de estudos é um processo simples e transparente.
          Siga os passos abaixo e dê o próximo grande salto na sua jornada
          educacional!
        </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 relative z-10">
            {stepsData.map((step, index) => (
              ...
              >
                ...
                <h3 className="text-xl font-semibold text-slate-800 mb-2 mt-2">
                  {step.title}
                </h3>
