...
export default function Footer() {
  const socialLinks = [
    {
      href: "https://www.instagram.com/proleduca/",
      icon: <FaInstagram size={24} />,
      label: "Instagram",
    },
    {
      href: "https://www.facebook.com/proleduca/?locale=pt_BR",
      icon: <FaFacebook size={24} />,
      label: "Facebook",
    },
    {
      href: "https://br.linkedin.com/company/prol-educa",
  ...
  const footerSections = [
    {
      ...
      content: (
        <Link to="/portal/login" className="hover:text-blue-600 underline">
    ...
    },
    {
      ...
      links: [
        ...
        { to: "/portal/#opportunities", text: "Explore Oportunidades" },
        { to: "/portal/suport", text: "Suporte" },
      ],
    },
  ];
    ...
    <footer className="bg-slate-100 text-slate-700 border-t border-slate-200">
                ...
                <ul className="space-y-2">
                  {section.links.map((link) => (
                    <li key={link.text}>
                      <Link
                        to={link.to}
                        className="text-slate-600 hover:text-blue-600 hover:underline transition-colors duration-300"
                      >
                        {link.text}
                      </Link>
                    </li>
      ...
      <div className="bg-slate-200 text-center py-5">
        <p className="text-xs text-slate-600">
          © {new Date().getFullYear()} Prol Educa (Edupass). Todos os direitos
          reservados.
        </p>
      </div>
    </footer>
