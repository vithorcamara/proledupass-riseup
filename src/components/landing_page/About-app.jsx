...
const cards = [
  { icon: GraduationCap, title: "Acesso à educação de qualidade", text: "Educação de qualidade com bolsas de estudo de até 80%" },
  { icon: Wallet, title: "Alívio no orçamento familiar", text: "Ajude seus colaboradores a economizar com educação e alivie o orçamento familiar" },
  { icon: FileCheck, title: "Matrícula gratuita", text: "Seu colaborador estuda com bolsa e ainda tem matrícula 100% gratuita" },
];
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        <div>
          ...
          <ul className="space-y-5">
            {reasons.map((r) => (
              <li key={r} className="flex items-start gap-4 bg-white border border-slate-100 rounded-xl p-5 shadow-sm">
