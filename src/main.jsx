      ...
      children: [
        {
          ...
          children: [
            ...
            {
              path: "scholarship-holders/new",
              element: <ScholarshipHolderForm />,
            },
            {
              path: "scholarship-holders/edit/:id",
              element: <ScholarshipHolderForm />,
            },
            ...
            {
              path: "AuthorizedUsers/edit/:id",
              element: <AuthorizedUsersForm />,
            },
          ],
        },
      ],
      ...
      children: [
        {
          ...
          children: [
            ...
            { path: "registrations", element: <CompanyRegistrations /> },
            {
              ...
              element: <CompanyRegistrationsDetails />,
            },
            ...
            {
              path: "AuthorizedUsers/new",
              element: <CompanyAuthorizedUsersForm />,
            },
          ],
        },
      ],
